    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Не опубликован', 'Не опубликован'), ('Опубликован', 'Опубликован')], max_length=50, verbose_name='Статус')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='webapp.category', verbose_name='Категория')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Автор', to='webapp.post', verbose_name='Пост')),
            ],
        ),
    ]
